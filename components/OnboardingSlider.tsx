...
const slides: SlideData[] = [
  {
    ...
    description: 'Der am schnellsten wachsende Sport der Welt!',
    bulletPoints: [
      '🎾 Einfach zu erlernen',
      '👥 Gemeinschaftsorientiert',
      '💪 Großartiges Workout',
      '🏆 Wettkampf oder Freizeitspaß',
    ],
    showImage: false,
  },
  {
    ...
    description: 'Die aktivste Pickleball-Community in Salzburg!',
    bulletPoints: [
      '🏅 Training für alle Levels',
      '🎯 Turniere und Events',
      '🤝 Freundliche Community',
      '📍 Moderne Spielstätten',
    ],
  ...
  },
  {
    ...
    description: 'Starte jetzt deine Pickleball-Reise!',
    bulletPoints: [
      '📱 Event-Anmeldung',
      '👫 Finde Spielpartner',
